    ...
    <div className="flex items-center w-full rounded-lg bg-yellow-400 lg:w-[500px]">
      ...
      <div className="p-2">
        <div className="flex gap-2">
          <h1 key={playerProps.id} className="text-yellow-700 font-extrabold lg:hidden"><span className="text-lime-900 drop-shadow-lg shadow-black">Nome:</span> {playerProps.surname2}</h1>
        ...
        <div className="flex flex-col">
          ...
          <Stars qtd={parseInt(playerProps.stars)} size={25} color="#5a8a10"/>
        </div>
      </div>
    </div>
  )

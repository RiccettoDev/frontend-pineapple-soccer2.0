...
export default function Header() {
  ...
  return (
    <div className="bg-slate-900 w-full h-24 flex p-4 items-center justify-between shadow-2xl shadow-black absolute z-50">
      <div>
        <Link to={'/home'} className="flex items-center p-2 custom:m-12">
      ...
      <div>
        <ul className='hidden lg:flex lg:m-16 lg:mb-10 lg:gap-6 custom:m-36 custom:gap-12'>
          ...
          <li className=' lg:text-lime-500 lg:font-extrabold lg:text-xl lg:hover:scale-105 lg:hover:text-white custom:text-3xl'><Link to={'/match'}>Pelada</Link></li>
        ...
        <div className={visible ? '' : 'hidden'}>
          <div className="animate-opacity w-[300px] h-full right-0 bg-slate-800 fixed z-50 p-6 lg:hidden">
            ...
            <ul className="flex flex-col right-12 top-28 gap-6 absolute">
              ...
              <li className="font-extrabold text-2xl text-lime-500 hover:text-white hover:scale-110"><Link onClick={() => setVisible(!visible)} to={'/match'}>Pelada</Link></li>
              <li className="font-extrabold text-2xl text-lime-500 hover:text-white hover:scale-110"><Link onClick={() => setVisible(!visible)} to={'/teams'}>Times</Link></li>
            </ul>
          </div>

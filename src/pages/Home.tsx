...
export default function Home(){
  return(
    <div>
      ...
      <img src={pineapple} alt="image pineapple" className='absolute left-6 top-[250px] z-30 h-48 lg:h-[250px] lg:left-[400px] lg:top-[150px] custom:left-[800px] custom:h-[500px] custom:top-[500px]' />
      <div className='flex items-end p-4 justify-center w-[350px] h-[255px] top-[280px] left-6 bg-gray-800 rounded-2xl absolute z-20 opacity-70 lg:p-10 lg:w-[600px] lg:h-[250px] lg:left-[340px] lg:top-[250px] custom:w-[2000px] custom:left-60 custom:h-[600px] custom:top-[650px]'>

...
export default function Teams() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center pt-32">
      ...
      <div className='flex flex-col pt-20 mb-8 relative lg:w-[50%] lg:pt-36'>
      ...
      <div className='flex flex-col pt-20 mb-8 lg:w-[50%] lg:pt-36'>
        <img src={field} alt="image field" className='w-[390px] transform rotate-90 lg:w-full' />
        ...
        <div className='w-14 h-14 bg-white rounded-full absolute left-[95px] top-[860px] active:scale-150 lg:w-28 lg:h-28 lg:left-[470px] lg:top-[1200px]'>
          <img src="https://i.ibb.co/mTv8Zrh/Breno.png" alt="" className='w-[100%] h-[100%] rounded-full' />
        </div>
        <div className='w-14 h-14 bg-white rounded-full absolute left-[245px] top-[860px] active:scale-150 lg:w-28 lg:h-28 lg:left-[685px] lg:top-[1200px]'>
          <img src="https://i.ibb.co/WVbbmVR/Renan-Bonin.png" alt="" className='w-[100%] h-[100%] rounded-full ' />
        </div>
        <div className='w-14 h-14 bg-white rounded-full absolute left-[95px] top-[960px] active:scale-150 lg:w-28 lg:h-28 lg:left-[685px] lg:top-[1360px]'>
          <img src="https://i.ibb.co/LpXvJcx/Kamacho.png" alt="" className='w-[100%] h-[100%] rounded-full' />
        </div>
        <div className='w-14 h-14 bg-white rounded-full absolute left-[245px] top-[960px] active:scale-150 lg:w-28 lg:h-28 lg:left-[470px] lg:top-[1360px]'>
      ...
      <div className='flex flex-col pt-20 mb-8 lg:w-[50%] lg:pt-36'>
        ...
        <div className='w-14 h-14 bg-amber-400 rounded-full absolute left-[95px] top-[1320px] active:scale-150 lg:w-28 lg:h-28 lg:left-[470px] lg:top-[1890px]'>
          <img src="https://i.ibb.co/BswWHj6/Batata.png" alt="" className='w-[100%] h-[100%] rounded-full' />
        </div>
        <div className='w-14 h-14 bg-amber-400 rounded-full absolute left-[245px] top-[1320px] active:scale-150 lg:w-28 lg:h-28 lg:left-[685px] lg:top-[1890px]'>
          <img src="https://i.ibb.co/RTK6P1Z/Rodrigo.png" alt="" className='w-[100%] h-[100%] rounded-full' />
        </div>
        <div className='w-14 h-14 bg-amber-400 rounded-full absolute left-[95px] top-[1420px] active:scale-150 lg:w-28 lg:h-28 lg:left-[470px] lg:top-[2050px]'>
          <img src="https://i.ibb.co/GcMyTcj/pedrin-removebg-preview.png" alt="" className='w-[100%] h-[100%] rounded-full' />
        </div>
        <div className='w-14 h-14 bg-amber-400 rounded-full absolute left-[245px] top-[1420px] active:scale-150 lg:w-28 lg:h-28 lg:left-[685px] lg:top-[2050px]'>
